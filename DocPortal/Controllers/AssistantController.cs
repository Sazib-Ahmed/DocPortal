...
namespace DocPortal.Controllers
{
    public class AssistantController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            try
            {
                var data = AssistantService.GetAll();
        ...
        [HttpPost]
        [Route("api/assistant/add")]
        public HttpResponseMessage Add(AssistantDTO obj)
        {
            try
            {
                var res = AssistantService.Create(obj);
                if (res)
                {
        ...
        [HttpPost]
        [Route("api/assistant/update")]
        public HttpResponseMessage Update(AssistantDTO obj)
        {
            try
            {
                var res = AssistantService.Update(obj);
                if (res)
                {
